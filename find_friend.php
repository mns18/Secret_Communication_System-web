            ...
            <div class="component row p-4">
                                ...
                                while($user = mysqli_fetch_assoc($user_res)){
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><div class="col-8"><?php echo $user_name ?></div></td>
                                            <td><div class="col-2"> <a class="btn btn-primary" href="find_friend.php?user_id=<?php echo $login_id ?>&request_id=<?php echo $user_id ?>">Request</a> </div></td>
                                            </tr>
                                    <?php
                                }
                            }else{
                ...
                <?php 
                    if(isset($_GET['user_id'])&& isset($_GET['request_id'])){
                        ...
                        $request_query = "INSERT INTO connects (request_id, accecpt_id, connect_status) VALUES ($user_id, $request_id, 'request')";
                        $request_res = mysqli_query($connection, $request_query);
                        if($request_res){
                            header("Location: find_friend.php?user_id=$user_id");
                        }
                    }
                ?>
